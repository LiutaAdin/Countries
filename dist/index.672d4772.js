    ...
    const randomCountry = async function() {
        ...
        try {
            ...
            <span>${(randomData.population / 1000000).toFixed(1)} m</span>
               ...
               <div class="data-info">
               <h4>Currencies:</h4>
               <span>${randomData.currencies[Object.keys(randomData.currencies)].name} - ${Object.keys(randomData.currencies)}</span>
               </div>
               
               <div class="data-info">
               <h4> Language:</h4>
               <span>${randomData.languages[Object.keys(randomData.languages)]} </span>
               </div>
               </div>`;
        } catch (err) {
